...
// TDH
import static com.concentriclivers.mms.android.provider.Telephony.Sms.Intents.SMS_RECEIVED_ACTION;
...
import com.concentriclivers.mms.com.android.mms.ui.ClassZeroActivity;
...
import com.concentriclivers.mms.android.provider.Telephony.Sms.Inbox;
import com.concentriclivers.mms.android.provider.Telephony.Sms.Intents;
import com.concentriclivers.mms.android.provider.Telephony.Sms.Outbox;
...
//        }
    ...
    private static String translateResultCode(int resultCode) {
        switch (resultCode) {
            ...
            case RESULT_ERROR_FDN_CHECK_FAILURE:
...
//        }
    ...
    private void handleServiceStateChanged(Intent intent) {
    	// TDH: Stock app will do it.
    	return;
//        // If service just returned, start sending out the queued messages
//    	// TDH: Don't use private API.
////        ServiceState serviceState = ServiceState.newFromBundle(intent.getExtras());
////        if (serviceState.getState() == ServiceState.STATE_IN_SERVICE) {
//        if (intent.getExtras().getInt("state") == ServiceState.STATE_IN_SERVICE) {
...
//        }
    ...
    private void handleSmsSent(Intent intent, int error) {
        ...
        if (mResultCode == Activity.RESULT_OK) {
            ...
            // TDH: RESULT_ERROR_FDN... not public yet.
        } else if (mResultCode == RESULT_ERROR_FDN_CHECK_FAILURE) {
            mToastHandler.post(new Runnable() {
                public void run() {
    ...
    private void handleSmsReceived(Intent intent, int error) {
    	// TDH: We may need to allow time for the stock app to write the text into the inbox.
    	// I'm going to do it just in case. It does seem to help a bit.
    	try
		{
    		// TDH: Increased to 2 seconds since someone said they
    		// weren't reliably receiving them.
			Thread.sleep(2000);
		}
        ...
        // TDH: We shouldn't insert the message since the stock
        // app will do it for us.
//        Uri messageUri = insertMessage(this, msgs, error, format);
        
        // TDH: But we still need the message threadId and to notify the widget.
        ...
        if (((threadId == null) || (threadId == 0)) && (address != null)) {
            threadId = Conversation.getOrCreateThreadId(this, address);
            values.put(Sms.THREAD_ID, threadId);
        }
    	// TDH
    	Log.d("NotificationDebug", "threadId: " + threadId);
...
//        }
    ...
    private void handleBootCompleted() {
    	...
    	// TDH: The main app can do these things.
...
//                }
                // TDH: This does the same but not using private APIs.
                try
                {
                    body.append(sms.getDisplayMessageBody());
                }
