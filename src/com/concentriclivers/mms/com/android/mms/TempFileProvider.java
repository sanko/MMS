...
public class TempFileProvider extends ContentProvider {
    ...
    // TDH: Use unique name!
    public static final Uri SCRAP_CONTENT_URI = Uri.parse("content://com.concentriclivers.mms.com.android.mms.TempFileProvider/scrapSpace");

    private static final int MMS_SCRAP_SPACE = 1;
    private static final UriMatcher sURLMatcher = new UriMatcher(UriMatcher.NO_MATCH);
    static {
		// TDH
        sURLMatcher.addURI("com.concentriclivers.mms.com.android.mms.TempFileProvider", "scrapSpace", MMS_SCRAP_SPACE);
    }
