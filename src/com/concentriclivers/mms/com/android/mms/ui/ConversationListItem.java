...
public class ConversationListItem extends RelativeLayout implements Contact.UpdateListener,
    ...
    private CharSequence formatMessage() {
    	// TDH: TODO: Do this properly in my XML.
        ...
        if (mConversation.getMessageCount() > 1) {
            ...
            buf.append(getContext().getResources().getString(R.string.message_count_format,
        ...
        if (mConversation.hasDraft()) {
            buf.append(getContext().getResources().getString(R.string.draft_separator));
            int before = buf.length();
            int size;
    ...
    private void updateBackground() {
        ...
        // TDH: Method doesn't exist in ICS.
