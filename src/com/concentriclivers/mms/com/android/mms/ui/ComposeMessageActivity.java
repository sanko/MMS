...
import static com.concentriclivers.mms.com.android.mms.transaction.ProgressCallbackEntity.PROGRESS_ABORT;
import static com.concentriclivers.mms.com.android.mms.transaction.ProgressCallbackEntity.PROGRESS_COMPLETE;
import static com.concentriclivers.mms.com.android.mms.transaction.ProgressCallbackEntity.PROGRESS_START;
import static com.concentriclivers.mms.com.android.mms.transaction.ProgressCallbackEntity.PROGRESS_STATUS_ACTION;
import static com.concentriclivers.mms.com.android.mms.ui.MessageListAdapter.COLUMN_ID;
import static com.concentriclivers.mms.com.android.mms.ui.MessageListAdapter.COLUMN_MSG_TYPE;
import static com.concentriclivers.mms.com.android.mms.ui.MessageListAdapter.PROJECTION;
...
import com.concentriclivers.mms.android.provider.Telephony.Sms;
...
import com.concentriclivers.mms.com.android.internal.telephony.TelephonyProperties;
...
import com.concentriclivers.mms.com.android.mms.SystemPropertiesProxy;
...
import com.concentriclivers.mms.com.android.mms.data.WorkingMessage.MessageStatusListener;
import com.concentriclivers.mms.com.android.mms.drm.DrmUtils;
...
import com.concentriclivers.mms.com.android.mms.ui.MessageListView.OnSizeChangedListener;
import com.concentriclivers.mms.com.android.mms.ui.MessageUtils.ResizeImageResultCallback;
import com.concentriclivers.mms.com.android.mms.ui.RecipientsEditor.RecipientContextMenuInfo;
import com.concentriclivers.mms.com.android.mms.util.AddressUtils;
import com.concentriclivers.mms.com.android.mms.util.PhoneNumberFormatter;
import com.concentriclivers.mms.com.android.mms.util.SendingProgressTokenManager;
...
public class ComposeMessageActivity extends Activity
    ...
    // TDH: Increased this! It was a paltry 10.
    private static final int CHARS_REMAINING_BEFORE_COUNTER_SHOWN = 60;
    ...
    private void forwardMessage(final MessageItem msgItem) {
        ...
        getAsyncDialog().runAsync(new Runnable() {
            ...
            public void run() {
				...
				// TDH: Change class name.
                intent.setClassName(ComposeMessageActivity.this,
                        "com.concentriclivers.mms.com.android.mms.ui.ForwardMessageActivity");
                startActivity(intent);
            }
        }, R.string.building_slideshow_title);
    }
    ...
    private boolean isDrmRingtoneWithRights(long msgId) {
    	// TDH: Fuck this, who gets DRM'd ringtones by text on a fucking smartphone?
    	return false;
    ...
    private boolean isForwardable(long msgId) {
    	// TDH: Again, screw this. One day I will fix it maybe. Nah. I never will.
/*        PduBody body = null;
        try {
            body = SlideshowModel.getPduBody(this,
                        ContentUris.withAppendedId(Mms.CONTENT_URI, msgId));
        ...
        switch (cnt) {
            ...
            case 1: {
                ...
                if (!title.equals(number)) {
                	// TDH: TODO: Fix when new API allows.
    ...
    private void initRecipientsEditor() {
        ...
        // TDH: This messes up typing non-valid phone numbers.
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        switch (keyCode) {
            ...
            // TDH: Change annoying behaviour. I think this is for
            // Physical keyboards actually.
...
//    }
    ...
    private void processPickResult(final Intent data) {
        ...
        final Parcelable[] uris =
            data.getParcelableArrayExtra(EXTRA_PHONE_URIS);
    ...
    private void launchMultiplePhonePicker() {
        ...
        if (urisCount > 0) {
			// TDH
            intent.putExtra(EXTRA_PHONE_URIS, uris);
        }
    ...
    public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
    	// TDH: Bloody annoying behaviour! What's the point of the send key?
    	return false;
//        if (event != null) {
...
//        return true;
    ...
    private void sendMessage(boolean bCheckEcmMode) {
        if (bCheckEcmMode) {
        	...
        	// TDH: Use SystemPropertiesProxy.
            String inEcm = SystemPropertiesProxy.get(this, TelephonyProperties.PROPERTY_INECM_MODE);
        ...
        protected void onQueryComplete(int token, Object cookie, Cursor cursor) {
            switch(token) {
                case MESSAGE_LIST_QUERY_TOKEN:
                    ...
                    if (targetMsgId != -1) {
                    	// TDH: TODO: Getting NPE here. Why is cursor null? Where is it set?
                    ...
                    // TDH: TODO: What is the root cause of the NPEs I was getting here?
