...
import com.concentriclivers.mms.android.provider.Telephony.MmsSms;
import com.concentriclivers.mms.android.provider.Telephony.MmsSms.PendingMessages;
import com.concentriclivers.mms.android.provider.Telephony.Sms;
import com.concentriclivers.mms.android.provider.Telephony.Sms.Conversations;
import com.concentriclivers.mms.android.provider.Telephony.TextBasedSmsColumns;
...
//    static final int COLUMN_SMS_ERROR_CODE      = 11;
    ...
    static final int COLUMN_SMS_READ            = 7-1;
    static final int COLUMN_SMS_TYPE            = 8-1;
    static final int COLUMN_SMS_STATUS          = 9-1;
    static final int COLUMN_SMS_LOCKED          = 10-1;
    static final int COLUMN_SMS_ERROR_CODE      = 11-1;
...
//    static final int COLUMN_MMS_STATUS          = 23;
    ...
    static final int COLUMN_MMS_SUBJECT         = 12-1;
    static final int COLUMN_MMS_SUBJECT_CHARSET = 13-1;
    static final int COLUMN_MMS_DATE            = 14-1;
    
    static final int COLUMN_MMS_READ            = 16-2;
    static final int COLUMN_MMS_MESSAGE_TYPE    = 17-2;
    static final int COLUMN_MMS_MESSAGE_BOX     = 18-2;
    static final int COLUMN_MMS_DELIVERY_REPORT = 19-2;
    static final int COLUMN_MMS_READ_REPORT     = 20-2;
    static final int COLUMN_MMS_ERROR_TYPE      = 21-2;
    static final int COLUMN_MMS_LOCKED          = 22-2;
    static final int COLUMN_MMS_STATUS          = 23-2;
