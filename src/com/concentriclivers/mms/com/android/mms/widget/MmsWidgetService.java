...
package com.concentriclivers.mms.com.android.mms.widget;
...
import com.concentriclivers.mms.com.android.mms.ui.ConversationListItem;
...
public class MmsWidgetService extends RemoteViewsService {
    ...
    private static class MmsFactory
        ...
        private RemoteViews getViewMoreConversationsView() {
            ...
            // TDH: TODO: This goes to the compose message activity for some reason!
            // But works for stock app... wtf.
            view.setOnClickFillInIntent(R.id.widget_loading,
                    new Intent(mContext, ConversationList.class));
//            view.setOnClickFillInIntent(R.id.widget_loading,
//                    new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.microsoft.com")));
            return view;
        }
