...
package com.concentriclivers.mms.com.google.android.mms.util;
...
public final class PduCache extends AbstractCache<Uri, PduCacheEntry> {
    ...
    synchronized public PduCacheEntry purge(Uri uri) {
    	// TDH: Seems to be a bug here - crash when sending MMS according to comments, possibly HTC phones.
    	if (uri == null)
    	{
    		Log.d("PduCache", "Uri is null.");
    		return null;
    	}
