...
package com.concentriclivers.mms.android.provider;
...
// TDH: TODO: This does some writing to the database which I generally shouldn't do.
...
//            @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
            ...
            public static SmsMessage[] getMessagesFromIntent(
                ...
                for (int i = 0; i < pduCount; i++) {
                    pdus[i] = pduObjs[i];
                    // TDH: TODO: Update to new API when available.
